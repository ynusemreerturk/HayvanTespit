                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form  method="POST" action="{{route('login.post')}}"enctype="multipart/form-data">
                                    @csrf
                                    <a class="btn  text-white" href="{{route('homepage')}}" style="background-color: #3fa288; float: right; margin-top: 14px"><i class="fa fa-home"></i></a>
...
{{--                                    @endif--}}
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button class="btn btn-dark btn-lg btn-block" style="background-color: #3fa288;" type="submit">Giriş Yap</button>
                                    </div>

                                    <a class="small text-muted" href="#!">Şifremi unuttum</a>
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Hesabınız yok mu? <a href="{{route('contact')}}" style="color: #393f81;">İletişime Geç</a></p>
