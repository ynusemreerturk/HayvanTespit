...
@section('content')
            ...
            <div class="card-content pb-4">
                ...
                <div class="recent-message d-flex px-4 py-3">
                    ...
                    <div class="name ms-4">
                        ...
                        <h6 class="text-muted mb-0">{{$contact->message}}</h6>
                    </div>
                </div>
                @endforeach
                <div class="px-4">
    ...
    <script>
        ...
        async function drawTumChart() {
            const res = await fetch('{{route('action.dogruluk')}}');
        ...
        async function fetchKameraData() {
            const res = await fetch('{{route('action.kamera.dogruluk')}}');
            return res.json();
        }
        ...
        async function fetchHayvanData() {
            const res = await fetch('{{route('action.hayvan.dogruluk')}}');
            return res.json();
        }
