        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header">
                <div class="d-flex justify-content-between">
                    <div class="logo">
                        <a href="{{route('dashboard')}}"><img src="{{asset('images')}}/company_logo.png" style="width: 90px; height: 70px;" alt="Logo" srcset="">
                            <div style="font-size: 18px; float: right; display: flex; justify-content: space-between;  padding-top: 21px;">
                                <p style="color: #3fa288;">Admin&nbsp</p><p style="color: black;">Paneli</p>
                            </div>
                        </a>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item {{ Request::segment(1) == 'kameralar' ? 'active' : '' }}">
                        <a href="{{route('camera.index')}}" class='sidebar-link'>
                            <i class="fa fa-camera"></i>
                            <span>Kameralar</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ Request::segment(1) == 'aksiyonlar' ? 'active' : '' }}">
                        <a href="{{route('action.index')}}" class='sidebar-link'>
