...
{{--            <h4 class="m-0 font-weight-bold float-left text-primary"><strong></strong></h4>--}}
            ...
            <hr style="color: #3fa288; width: 310px;height: 2px;">
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form method="POST" action="{{route('user.create.post')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <button type="submit" style="background-color: #3fa288; border-color: #3fa288;" class="btn btn-primary btn-block">Kullanıcı Oluştur</button>
                </div>
            </form>
        </div>
    </div>
