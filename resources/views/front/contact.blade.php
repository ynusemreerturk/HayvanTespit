...
@section('content')
    ...
    <div class="breadcrumb-section breadcrumb-bg" style="width: 100%; height: 451px; padding: 0px 0px 0px 0px;">
        <img src="{{asset('images')}}/4bcfb1ce-6a74-49d8-8729-3e4d8de00166.png" style="width: 100%; height: 100%; position: absolute; opacity: 50%; object-fit: cover;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="contact-form-wrap">
                        ...
                        <div class="contact-form-box">
                            ...
                            <p>Telefon: +90 111 222 3333 <br> Email: support@animalguard.com</p>
                        </div>
                    </div>
                </div>
            </div>
